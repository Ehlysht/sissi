...
<head>
	...
	<title>Товари для макіяжу обличча</title>
	<meta name="Description" content="Якісна космети для обличча очей відомих брендів"> 
	<meta name="keywords" content="интернет-магазин, товари для макіяжу обличча, купити, замовити, доставляємо по Україні, косметика, акції, відомі бренди, Kiko Milano, HASK, Rolanjona">
</head>
<?php include 'header.php';
    $pagename = 'makeuplips';
?>
    <p class='subpagename d-none'>face</p>
	        ...
	        <div class="row">
	            <div class="col-12">
	                <div class="firstimg__all">
	                    <img src="img/makefacesection.png" alt="Макіяж для обличчя" class="makeface__firstimg d-md-none d-block">
	                    <img src="img/makefaceitem.png" alt="Макіяж для обличчя" class="items-img makeface__firstimg ml-auto d-md-block d-none">
	                </div>
	            </div>
	        </div>
	    </div>
					...
					<div class="sales-materials sales__makeup">
						...
						<div class="makeup__all d-flex flex-wrap">
							<?php
								...
								$query ="SELECT id, name, used, price, link, type, manufname, color1, noStock FROM items WHERE type ='makeupface'";
								...
								if($result)
								{
								    ...
								    while ($row = mysqli_fetch_row($result)) {
									    ...
									    echo "<input type='hidden' name='toDoSite' value='../makeupface.php'>";
									    echo "<input type='hidden' name='forCrubs' value='Макіяж обличчя'>";
                        		        ...
                        		        echo "<input type='hidden' name='fromsubpage' value='makeupface'/>";
