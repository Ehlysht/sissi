...
<head>
	...
	<title>Товари для макіяжу губ</title>
	<meta name="Description" content="Якісна космети для макіяжу губ відомих брендів"> 
	<meta name="keywords" content="интернет-магазин, товари для макіяжу губ, купити, замовити, доставляємо по Україні, косметика, акції, відомі бренди, Kiko Milano, HASK, Rolanjona">
</head>
<?php include 'header.php'; 
    $pagename = 'makeuplips';
?>
    <p class='subpagename d-none'>lips</p>
	        ...
	        <div class="row">
	            <div class="col-12">
	                <div class="firstimg__all">
	                    <img src="img/makelipssection.png" alt="Макіяж для губ" class="makelips__firstimg d-md-none d-block">
	                    <img src="img/makelipsitem.png" alt="Макіяж для губ" class="items-img makelips__firstimg ml-auto d-md-block d-none">
	                </div>
	            </div>
	        </div>
	    </div>
					...
					<div class="sales-materials sales__makeup">
						...
						<div class="makeup__all d-flex flex-wrap">
							<?php
								...
								$query ="SELECT id, name, used, price, link, type, manufname, color1, noStock FROM items WHERE type ='makeuplips'";
								...
								if($result)
								{
								    ...
								    while ($row = mysqli_fetch_row($result)) {
									    ...
									    echo "<input type='hidden' name='toDoSite' value='../makeuplips.php'>";
									    echo "<input type='hidden' name='forCrubs' value='Макіяж губ'>";
                        		        ...
                        		        echo "<input type='hidden' name='fromsubpage' value='makeuplips'/>";
